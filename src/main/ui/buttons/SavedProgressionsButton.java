...
public class SavedProgressionsButton extends Button {
    ...
    protected void addListener() {
        button.addActionListener(new SavedProgressionsButton.SavedProgressionsClickHandler());
    }
    ...
    public String getLabel() {
        return "Saved Progressions";
    }

    private class SavedProgressionsClickHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            musicApp.setActiveButton(SavedProgressionsButton.this);
            musicApp.openSavedPlaylists();
        }
    }
}
